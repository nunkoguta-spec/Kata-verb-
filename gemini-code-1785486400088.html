...
<head>
  ...
  <title>Deutscher Konjugator - 800 Verben</title>
  <style>
    :root {
      --bg: #f8fafc;
      --card-bg: #ffffff;
...
<script>
  const verbDatabase = {
    ...
    "möchten": { meaning: "ingin (sopan)", type: "modal", forms: { "ich": "möchte", "du": "möchtest", "er/sie/es": "möchte", "wir": "möchten", "ihr": "möchtet", "sie/Sie": "möchten" } },
    ...
    "singen": { meaning: "bernyanyi", type: "irregular", forms: { "ich": "singe", "du": "singst", "er/sie/es": "singt", "wir": "singen", "ihr": "singt", "sie/Sie": "singen" } },
    ...
    "zurückkommen": { meaning: "kembali", type: "separable", forms: { "ich": "komme zurück", "du": "kommst zurück", "er/sie/es": "kommt zurück", "wir": "kommen zurück", "ihr": "kommst zurück", "sie/Sie": "kommen zurück" } },
